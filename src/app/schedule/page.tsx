...
function getManualSchedule(): {
  ...
  const calendarIntakes: CalendarIntake[] = [
    ...
    },
    {
      ...
      scheduledDate: date(19),
      scheduledTimeWindow: "06:00-14:30",
      note: "Truck 1 loading today (>20 tons, ~40,000 lbs). Pallets of dog food (not totes) - VR# pending.",
      estimatedWeight: 22,
      client: { companyName: "Vanguard (Purina/Flagstaff)", accountNumber: "" },
      statusTag: "scheduled",
      status: "scheduled",
    ...
    },
    {
      ...
      scheduledDate: date(19),
      scheduledTimeWindow: "06:00-14:30",
      note: "Truck 2 loading today (>20 tons, ~40,000 lbs). Pallets of dog food (not totes) - VR# pending.",
      estimatedWeight: 22,
      client: { companyName: "Vanguard (Purina/Flagstaff)", accountNumber: "" },
      statusTag: "scheduled",
      status: "scheduled",
