                ...
                {intakes.map((intake) => (
                  <tr key={intake.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <Link href={`/intakes/${intake.id}`} className="font-mono text-sm font-medium text-emerald-600 hover:text-emerald-800">
                        {intake.ticketNumber}
                      </Link>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm">
                      <Link href={`/intakes/${intake.id}`} className="text-emerald-600 hover:text-emerald-900">
                        View
                      </Link>
                    </td>
                  </tr>
