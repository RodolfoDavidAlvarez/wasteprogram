...
export default async function IntakesPage() {
  ...
  return (
    <div>
      <Header
        title="Waste Intakes"
        subtitle="Manage all waste intake requests and tickets"
      />
      <div className="p-6">
        {/* Actions Bar */}
          ...
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <p className="mt-2 text-sm text-gray-500">
                Get started by creating your first waste intake request.
              </p>
              <Link href="/intake/new">
                  ...
                  <tr key={intake.id} className="hover:bg-gray-50">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <Link
                        ...
                        className="font-mono text-sm font-medium text-emerald-600 hover:text-emerald-800"
                      >
                        {intake.ticketNumber}
                      </Link>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <div className="text-xs text-gray-500">
                        {intake.client.accountNumber}
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {getWasteTypeLabel(intake.wasteType)}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-gray-900">
                        {intake.actualWeight
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      {formatDate(intake.scheduledDate)}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
